...
#ifndef XU_LESSEQFN_H_
#define XU_LESSEQFN_H_
...
class LessEqFn : public Function
{

public:

    LessEqFn();
    LessEqFn(const LessEqFn &  other);
    LessEqFn(LessEqFn &&  other) noexcept;
    LessEqFn(std::string const &  classname, MyClass *  parent);
    virtual ~LessEqFn() noexcept;
