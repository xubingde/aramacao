...
#ifndef XU_PRIVATELABEL_H_
#define XU_PRIVATELABEL_H_
...
class PrivateLabel : public EObject
{

public:

    PrivateLabel();
    PrivateLabel(const PrivateLabel &  other);
    PrivateLabel(PrivateLabel &&  other) noexcept;
    virtual ~PrivateLabel() noexcept;
