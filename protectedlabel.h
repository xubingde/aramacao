...
#ifndef XU_PROTECTEDLABEL_H_
#define XU_PROTECTEDLABEL_H_
...
class ProtectedLabel : public EObject
{

public:

    ProtectedLabel();
    ProtectedLabel(const ProtectedLabel &  other);
    ProtectedLabel(ProtectedLabel &&  other) noexcept;
    virtual ~ProtectedLabel() noexcept;
